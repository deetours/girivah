      ...
      >
        ...
        >
          <span className="font-mono text-[9px] tracking-[0.4em] uppercase text-accent">
            GIRIVAH EXPEDITIONS // SPITI CIRCUIT
          </span>
        ...
        <div className="flex-1 flex flex-col justify-center max-w-3xl">
          ...
          >
            ...
            <p className="font-sans text-white/50 text-sm md:text-base leading-relaxed max-w-md mt-6 tracking-wide">
              The valley has been waiting. 15,059 feet of silence, ancient monasteries, and terrain
              that does not forgive the unprepared.{" "}
              <span className="text-white/80">This is your call.</span>
            </p>
