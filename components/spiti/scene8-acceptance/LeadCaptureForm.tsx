                  ...
                  <div className="space-y-3">
                    {vehicleTiers.map((tier) => (
                      <motion.button
                        ...
                        style={{
                          borderColor: formData.tier === tier.id ? "#FF3E00" : "rgba(255,255,255,0.1)",
                          backgroundColor: formData.tier === tier.id ? "#FF3E00" + "08" : "rgba(255,255,255,0.02)",
                        }}
                      >
              ...
              {step === 3 && (
                ...
                >
                  ...
                  <p className="font-mono text-[7px] tracking-[0.2em] uppercase text-white/20 text-center mt-4">
                    By submitting, you agree to receive a briefing call about the Spiti Siege. No spam.
                  </p>
                </motion.div>
              )}
            </AnimatePresence>
