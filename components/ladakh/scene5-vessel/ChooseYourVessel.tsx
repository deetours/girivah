...
function DossierTier({ tier, isOpen, onToggle }: {
  ...
  return (
    <motion.div
      ...
      animate={{
        borderColor: isOpen ? tier.accentColor + "40" : "rgba(255,255,255,0.1)",
      }}
    ...
    >
      ...
      <motion.button
        ...
        animate={{
          backgroundColor: isOpen ? tier.accentColor + "08" : "transparent",
        }}
      >
        <div className="text-left">
          <div className="font-mono text-[10px] tracking-[0.3em] uppercase mb-2" style={{ color: tier.accentColor }}>
        ...
        <motion.div
          ...
          transition={{ duration: 0.3 }}
          style={{ color: tier.accentColor, fontSize: 20 }}
        >
          ▼
        </motion.div>
      </motion.button>
