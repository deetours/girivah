...
import { VehicleTier as VehicleTierType } from "@/components/ladakh/data/expeditionData"
  ...
  if (isFocusMode) {
    return (
      <motion.div
        ...
        style={{
          borderColor: isSelected ? tier.accentColor : "rgba(255,255,255,0.1)",
          backgroundColor: isSelected ? tier.accentColor + "05" : "rgba(255,255,255,0.02)",
        }}
      >
        {/* Background image */}
        ...
        <div className="relative z-10 flex flex-col justify-between h-full">
          ...
          <motion.div animate={{ scale: isSelected ? 1.05 : 1 }}>
            <span className="font-mono text-[8px] tracking-[0.35em] uppercase" style={{ color: tier.accentColor }}>
              {tier.tier}
              {tier.isRecommended && " ⭐"}
            </span>
          </motion.div>
          ...
          <div>
            ...
            <p className="font-display text-2xl font-black" style={{ color: tier.accentColor }}>
              {tier.price}
            </p>
          ...
          <motion.button
            ...
            style={{
              ...
              backgroundColor: isSelected ? tier.accentColor + "20" : tier.accentColor + "08",
            }}
          >
